...
class App(object):
    ...
    def counting_angular_rotation_time(self, angles, angular_speed):
        angular_rotation_time = 0

        for i in range(len(angles)):
            # self.angular_rotation_time.append(abs(self.angles[i] / self.bot_angular_velocity))
            angular_rotation_time = abs(angles[i] / angular_speed)
        return angular_rotation_time
